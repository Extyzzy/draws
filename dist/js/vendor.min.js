...
e.$dots.find("li").eq(Math.floor(e.currentSlide/e.options.slidesToScroll)).addClass("slick-active").attr("aria-hidden","false"))},t.prototype.visibility=function(){var e=this;e.options.autoplay&&(document[e.hidden]?e.interrupted=!0:e.interrupted=!1)},e.fn.slick=function(){var e,n,i=this,o=arguments[0],r=Array.prototype.slice.call(arguments,1),s=i.length;for(e=0;s>e;e++)if("object"==typeof o||"undefined"==typeof o?i[e].slick=new t(i[e],o):n=i[e].slick[o].apply(i[e].slick,r),"undefined"!=typeof n)return n;return i}}),function(e){"use strict";e.fn.bPopup=function(t,n){function i(){v(b.onOpen),z=(P.data("bPopup")||0)+1,x=I+z+"__",k="auto"!==b.position[1],S="auto"!==b.position[0],C="fixed"===b.positionStyle,E=L.outerHeight(!0),j=L.outerWidth(!0),b.loadUrl?o():r()}function o(){switch(b.contentContainer=e(b.contentContainer||L),b.content){case"iframe":var t=e('<iframe class="b-iframe" '+b.iframeAttr+"></iframe>");t.appendTo(b.contentContainer),E=L.outerHeight(!0),j=L.outerWidth(!0),r(),t.attr("src",b.loadUrl),v(b.loadCallback);break;case"image":r(),e("<img />").load(function(){v(b.loadCallback),l(e(this))}).attr("src",b.loadUrl).hide().appendTo(b.contentContainer);break;default:r(),e('<div class="b-ajax-wrapper"></div>').load(b.loadUrl,b.loadData,function(t,n,i){v(b.loadCallback,n),l(e(this))}).hide().appendTo(b.contentContainer)}}function r(){b.modal&&e('<div class="b-modal '+x+'"></div>').css({backgroundColor:b.modalColor,position:"fixed",top:0,right:0,bottom:0,left:0,opacity:0,zIndex:b.zIndex+z}).appendTo(b.appendTo).fadeTo(b.speed,b.opacity),g(),L.data("bPopup",b).data("id",x).css({left:"slideIn"==b.transition||"slideBack"==b.transition?"slideBack"==b.transition?N.scrollLeft()+M:(A+j)*-1:f(!(!b.follow[0]&&S||C)),position:b.positionStyle||"absolute",top:"slideDown"==b.transition||"slideUp"==b.transition?"slideUp"==b.transition?N.scrollTop()+q:$+E*-1:h(!(!b.follow[1]&&k||C)),"z-index":b.zIndex+z+1}).each(function(){b.appending&&e(this).appendTo(b.appendTo)}),u(!0)}function s(){return b.modal&&e(".b-modal."+L.data("id")).fadeTo(b.speed,0,function(){e(this).remove()}),d(),clearTimeout(H),u(),!1}function a(t){q=m(),M=w(),T=y(),(T.x||T.y)&&(clearTimeout(D),D=setTimeout(function(){g(),t=t||b.followSpeed;var n={};T.x&&(n.left=b.follow[0]?f(!0):"auto"),T.y&&(n.top=b.follow[1]?h(!0):"auto"),L.dequeue().each(function(){C?e(this).css({left:A,top:$}):e(this).animate(n,t,b.followEasing)})},50))}function l(e){var t=e.width(),n=e.height(),i={};b.contentContainer.css({height:n,width:t}),n>=L.height()&&(i.height=L.height()),t>=L.width()&&(i.width=L.width()),E=L.outerHeight(!0),j=L.outerWidth(!0),g(),b.contentContainer.css({height:"auto",width:"auto"}),i.left=f(!(!b.follow[0]&&S||C)),i.top=h(!(!b.follow[1]&&k||C)),L.animate(i,250,function(){e.show(),T=y()})}function c(){P.data("bPopup",z),L.delegate(".bClose, ."+b.closeClass,"click."+x,s),b.modalClose&&e(".b-modal."+x).css("cursor","pointer").bind("click",s),F||!b.follow[0]&&!b.follow[1]||P.bind("scroll."+x,function(){if(T.x||T.y){var e={};T.x&&(e.left=b.follow[0]?f(!C):"auto"),T.y&&(e.top=b.follow[1]?h(!C):"auto"),L.dequeue().animate(e,b.followSpeed,b.followEasing)}}).bind("resize."+x,function(){a()}),b.escClose&&N.bind("keydown."+x,function(e){27==e.which&&s()})}function d(){b.scrollBar||e("html").css("overflow","auto"),e(".b-modal."+x).unbind("click"),N.unbind("keydown."+x),P.unbind("."+x).data("bPopup",P.data("bPopup")-1>0?P.data("bPopup")-1:null),L.undelegate(".bClose, ."+b.closeClass,"click."+x,s).data("bPopup",null)}function u(e){function t(t){L.css({display:"block",opacity:1}).animate(t,b.speed,b.easing,function(){p(e)})}switch(e?b.transition:b.transitionClose||b.transition){case"slideIn":t({left:e?f(!(!b.follow[0]&&S||C)):N.scrollLeft()-(j||L.outerWidth(!0))-W});break;case"slideBack":t({left:e?f(!(!b.follow[0]&&S||C)):N.scrollLeft()+M+W});break;case"slideDown":t({top:e?h(!(!b.follow[1]&&k||C)):N.scrollTop()-(E||L.outerHeight(!0))-W});break;case"slideUp":t({top:e?h(!(!b.follow[1]&&k||C)):N.scrollTop()+q+W});break;default:L.stop().fadeTo(b.speed,e?1:0,function(){p(e)})}}function p(e){e?(c(),v(n),b.autoClose&&(H=setTimeout(s,b.autoClose))):(L.hide(),v(b.onClose),b.loadUrl&&(b.contentContainer.empty(),L.css({height:"auto",width:"auto"})))}function f(e){return e?A+N.scrollLeft():A}function h(e){return e?$+N.scrollTop():$}function v(t,n){e.isFunction(t)&&t.call(L,n)}function g(){$=k?b.position[1]:Math.max(0,(q-L.outerHeight(!0))/2-b.amsl),A=S?b.position[0]:(M-L.outerWidth(!0))/2,T=y()}function y(){return{x:M>L.outerWidth(!0),y:q>L.outerHeight(!0)}}function m(){return P.height()}function w(){return P.width()}e.isFunction(t)&&(n=t,t=null);var b=e.extend({},e.fn.bPopup.defaults,t);b.scrollBar||e("html").css("overflow","hidden");var x,T,k,S,C,$,A,E,j,D,H,L=this,N=e(document),O=window,P=e(O),q=m(),M=w(),I="__b-popup",F=/OS 6(_\d)+/i.test(navigator.userAgent),W=200,z=0;return L.close=function(){s()},L.reposition=function(e){a(e)},L.each(function(){e(this).data("bPopup")||i()})},e.fn.bPopup.defaults={amsl:50,appending:!0,appendTo:"body",autoClose:!1,closeClass:"b-close",content:"ajax",contentContainer:!1,easing:"swing",escClose:!0,follow:[!0,!0],followEasing:"swing",followSpeed:500,iframeAttr:'scrolling="no" frameborder="0"',loadCallback:!1,loadData:!1,loadUrl:!1,modal:!0,modalClose:!0,modalColor:"#000",onClose:!1,onOpen:!1,opacity:.7,position:["auto","auto"],positionStyle:"absolute",scrollBar:!0,speed:250,transition:"fadeIn",transitionClose:!1,zIndex:9997}}(jQuery);